define(["app"], function(app) {
  /*修改$ionicLoading的模板设置，可以更灵活地设置模板*/
  /*start*/
  app.register.factory('$ionicdefinedLoading', DefinedLoading);

  function noop() {}

  DefinedLoading.$inject = ['$ionicLoading', '$ionicLoadingConfig',
    '$ionicBody',
    '$ionicTemplateLoader',
    '$ionicBackdrop',
    '$timeout',
  ...
  function DefinedLoading($ionicLoading, $ionicLoadingConfig, $ionicBody, $ionicTemplateLoader, $ionicBackdrop, $timeout, $q, $log, $compile, $ionicPlatform, $rootScope, IONIC_BACK_PRIORITY) {
    var loaderInstance;
    //default values
        ...
        loaderInstance = $ionicTemplateLoader.compile({
          ...
          .then(function(self) {
            ...
            self.hide = function() {
              deregisterBackAction();
              var loading = self.element.children();
              loading.children().eq(0).addClass("opacity-hide-absolute");
              setTimeout(function() {
                if(self.isShown) {
                  if(self.hasBackdrop) {
    ...
    function showLoader(options) {
      options = angular.extend({}, $ionicLoadingConfig || {}, options || {});
